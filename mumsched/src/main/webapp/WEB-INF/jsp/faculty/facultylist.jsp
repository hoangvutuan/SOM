			...
			<tbody>
				<c:forEach items="${faculties}" var="faculty" varStatus="loop">
					<tr>
						...
						<td><fmt:formatDate pattern="MM/dd/yyyy" value="${faculty.dob}" /></td>
						<td>${faculty.email}</td>
						<td>
							<table>
							<tbody>
						...
						<td>
						<a href='javascript:editFaculty(${faculty.id})'><span class="glyphicon glyphicon-pencil"></span> </a>|
							<a href='javascript:deleteFaculty(${faculty.id})'><span class="glyphicon glyphicon-trash"></span></a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
